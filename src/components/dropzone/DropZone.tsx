    ...
    >
      ...
      >
        ...
        <h1 style={{ margin: 0, fontSize: 24, fontWeight: 500, letterSpacing: '-0.01em' }}>
          Drop DICOM files or folders
        </h1>
        <p style={{ margin: '8px 0 24px', color: '#8b949e', fontSize: 15 }}>
          Supports <code className="mono" style={{ color: '#c9d1d9' }}>.dcm</code> files
          and extension-less DICOM files. Directory traversal is fully recursive.
        </p>
        ...
        <div style={{ display: 'flex', gap: 10, justifyContent: 'center' }}>
          ...
          <button
            onClick={() => {
              const el = document.getElementById('file-picker-single') as HTMLInputElement | null
              el?.click()
            }}
            style={{
              padding: '10px 18px',
